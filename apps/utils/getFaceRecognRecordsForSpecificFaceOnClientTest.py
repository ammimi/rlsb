...
def getFaceRecognRecordsForSpecificFace(server_url, params):
...
if __name__ == "__main__":
   ...
   #url = "http://192.168.1.219/cgi-bin/v0.13/historydata/getFaceRecognRecordsForSpecificFace.py?"
   url = "http://192.168.1.219/v0.13/historydata/getFaceRecognRecordsForSpecificFace?"
   ...
   params = {"client_id":clientId, "client_secret":clientSecret,"timestamp":timestamp,"face_id":faceId}

   paramNamesForSignature = sorted(["client_secret","client_id","timestamp","face_id"],key=str.lower)
   ...
   print(url)
   params = {}
   getFaceRecognRecordsForSpecificFace(url, params)
